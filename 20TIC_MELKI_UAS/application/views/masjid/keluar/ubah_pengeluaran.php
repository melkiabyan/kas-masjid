                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ubah Pengeluaran Kas Masjid</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="keluar" name="keluar" class="form-control" value="<?= $masjid['keluar']; ?>">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <img src="<?= base_url('assets/img/masjid/keluar/') . $masjid['gambar']; ?>" style="width :150px ;">
                                            </div>
                                        </div>
