                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ubah Pemasukan Kas Sosial</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="masuk" name="masuk" class="form-control" value="<?= $sosial['masuk']; ?>">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <img src="<?= base_url('assets/img/sosial/masuk/') . $sosial['gambar']; ?>" style="width :150px ;">
                                            </div>
                                        </div>
