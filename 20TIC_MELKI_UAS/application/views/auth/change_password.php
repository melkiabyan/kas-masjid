    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <p class="auth-subtitle mb-5">Input your email to change password.</p>
                ...
                <form method="POST" action="">
                    ...
                    <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">Change Password</button>
                </form>
