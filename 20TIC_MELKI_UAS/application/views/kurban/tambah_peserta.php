                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="first-name-column" class="form-control" name="tahun">
                                                <?= form_error('tahun', '<small class="text-danger pl-3">', '</small>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="first-name-column">Kode Kurban</label>
                                                <select name="id_JenisKurban" id="kode" class="form-control">
                                            ...
                                            <!-- <input type="hidden" name="id_JenisKurban" id="id_JenisKurban" value=1> -->
                                            <!-- <div class="form-group">
